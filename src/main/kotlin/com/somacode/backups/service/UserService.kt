...
import com.somacode.backups.repository.UserRepository
import com.somacode.backups.repository.criteria.UserCriteria
import com.somacode.backups.security.SecurityTool
...
class UserService {
    ...
    fun init() {
        if (userRepository.count() <= 0) {
            ...
            register(
                    email = "superadmin@backups.com",
                    password = password,
                    name = "Superadmin"
            )
            register(
                    email = "admin@backups.com",
                    password = "1234",
                    name = "Administrador"
            )
